...
# Authors: Villanueva G.L., Faggi S., Liuzzi G.
# Published: October 31st 2023
# DOI:10.5281/zenodo.10059232 (https://doi.org/10.5281/zenodo.10059232) 
# GitHub repository: https://github.com/nasapsg/astropsg
#
# astroPSG is a python package to process spectroscopic data that can be used over a 
# broad range of wavelengths (from optical to infrared), for both low- and high-resolution 
# spectrometers and it is applicable for both cometary and planetary atmosphere data. 
# It connects to the Planetary Spectrum Generator (PSG) [Villanueva et al., 2018; 2022] 
# radiative transfer models and allows retrievals of planetary parameters.
#
# To run $>python -m astropsg module=crop show=show reset=reset
